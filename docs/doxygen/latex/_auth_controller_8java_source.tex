...
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00009}00009\ \textcolor{keyword}{import}\ com.deusto.deuspotify.repositories.ProfileRepository;}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00010}00010\ \textcolor{keyword}{import}\ com.deusto.deuspotify.security.JwtUtil;}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00011}00011\ \textcolor{keyword}{import}\ com.deusto.deuspotify.services.ProfileService;}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00012}00012\ }
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00013}00013\ \textcolor{keyword}{import}\ org.springframework.beans.factory.annotation.Autowired;}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00014}00014\ \textcolor{keyword}{import}\ org.springframework.http.ResponseEntity;}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00015}00015\ \textcolor{keyword}{import}\ org.springframework.security.authentication.AuthenticationManager;}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00016}00016\ \textcolor{keyword}{import}\ org.springframework.security.authentication.UsernamePasswordAuthenticationToken;}
...
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00057}00057\ \ \ \ \ \ \ \ \ authenticationManager.authenticate(\textcolor{keyword}{new}\ UsernamePasswordAuthenticationToken(username,\ password));}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00058}00058\ }
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00059}00059\ \ \ \ \ \ \ \ \ String\ token\ =\ jwtUtil.generateToken(username);}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00060}00060\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ResponseEntity.ok(Map.of(\textcolor{stringliteral}{"{}token"{}},\ token));}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00061}00061\ \ \ \ \ \}}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00062}00062\ }
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00068}00068\ \ \ \ \ @PostMapping(\textcolor{stringliteral}{"{}/register"{}})}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00069}\mbox{\hyperlink{classcom_1_1deusto_1_1deuspotify_1_1controllers_1_1_auth_controller_a80a60e8d1896b6da14785851114988fa}{00069}}\ \ \ \ \ public\ ResponseEntity<?>\ register(@RequestBody\ Profile\ profile)\ \{}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00070}00070\ \ \ \ \ \ \ \ \ \textcolor{keywordflow}{return}\ ResponseEntity.ok(profileService.registerUser(profile));}
...
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00077}00077\ \ \ \ \ @PostMapping(\textcolor{stringliteral}{"{}/logout"{}})}
\DoxyCodeLine{\Hypertarget{_auth_controller_8java_source_l00078}\mbox{\hyperlink{classcom_1_1deusto_1_1deuspotify_1_1controllers_1_1_auth_controller_a9739f35c4e2d67faa2c7051192975f0d}{00078}}\ \ \ \ \ public\ ResponseEntity<?>\ logout()\ \{}
